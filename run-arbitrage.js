...
const init = async () => {
  ...
  web3.eth.subscribe('newBlockHeaders')
    .on('data', async block => {
      ...
      console.log('!!!!!!!! ' + (AMOUNT_DAI_WEI/(uniswapResults[0][0].toExact() * 10 ** 18)));
      const uniswapRates = {
